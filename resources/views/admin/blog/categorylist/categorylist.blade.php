                    ...
                    @forelse($categories as $category)
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="py-3.5 px-6 text-right space-x-1">
                                ...
                                <button @click="deleteId = {{ $category->id }}; deleteModalOpen = true" 
    ...
    <div x-show="deleteModalOpen" 
        ...
        <div x-show="deleteModalOpen" 
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="space-y-1">
                    <h3 class="font-heading font-bold text-slate-800 text-base">Delete Category</h3>
                    <p class="text-xs text-slate-500 leading-relaxed">Are you sure you want to delete this category? All related blog posts will be removed permanently. This action cannot be undone.</p>
                </div>
            </div>
