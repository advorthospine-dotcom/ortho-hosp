...
<div class="min-h-screen bg-slate-50/60 pb-20"
    ...
    <div class="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 py-10 sm:py-14 space-y-10">
        ...
        @else
            <!-- EMPTY STATE (Shown when no gallery images exist in database) -->
            <div class="bg-white border border-slate-200/80 rounded-2xl p-10 sm:p-14 text-center max-w-md mx-auto shadow-sm my-8">
                <div class="w-16 h-16 rounded-2xl bg-slate-100 text-slate-400 flex items-center justify-center mx-auto mb-4 border border-slate-200/60">
                    <i class="ri-gallery-line text-3xl text-slate-400"></i>
                </div>
                <h3 class="text-lg font-heading font-extrabold text-slate-900">No Gallery Photos Available</h3>
                <p class="text-xs sm:text-sm text-slate-500 mt-2 leading-relaxed font-medium">
                    There are currently no images uploaded in the hospital gallery. Please check back later.
                </p>
            </div>
        @endif
