...
<div class="min-h-screen bg-slate-50/60 pb-20">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        ...
        <!-- 4 Key Contact Information Cards -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-lg transition-all space-y-3 group relative overflow-hidden">
                <div class="w-12 h-12 rounded-2xl bg-rose-50 border border-rose-100 text-rose-600 flex items-center justify-center text-xl shadow-xs group-hover:scale-105 transition-transform">
        ...
        <!-- Layout Grid: Form (Left 2 Cols) & Arrival Guide (Right 1 Col) -->
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
            
            <!-- Contact / Appointment Form Card (Left 2 Cols) -->
            <div class="lg:col-span-2 bg-white border border-slate-200/80 rounded-3xl p-6 sm:p-10 shadow-sm space-y-6">
                ...
                <div class="space-y-1.5 border-b border-slate-100 pb-5">
                    ...
                    <p class="text-xs sm:text-sm text-slate-500">Fill out the form below and our clinical coordination desk will contact you promptly.</p>
                </div>
                    ...
                    <div class="p-4 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-900 space-y-2 flex items-start justify-between shadow-xs">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="space-y-1 text-xs">
                                <h4 class="font-heading font-extrabold text-sm text-emerald-950">Inquiry Received Successfully!</h4>
                                <p class="text-emerald-800 leading-relaxed">
                                    Thank you for reaching out to Advance Orthopaedic & Spine Center. Our patient care officer will call you shortly to assist with your inquiry.
                                </p>
                            </div>
                        </div>
                        <button wire:click="dismissSuccess" class="text-emerald-700 hover:text-emerald-950 cursor-pointer">
                ...
                <form wire:submit.prevent="submitForm" class="space-y-5">
                    ...
                    <div class="space-y-1.5">
                        <label class="block text-xs font-bold text-slate-700 uppercase tracking-wider">
                            Message / Symptoms Brief <span class="text-rose-500">*</span>
                        </label>
            ...
            <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="space-y-0.5 text-xs">
                                <h4 class="font-bold text-slate-800">Valet & Visitor Parking</h4>
                                <p class="text-slate-500 leading-relaxed">Dedicated multi-level parking building at Gate 2 with complimentary valet assistance for mobility-assisted patients.</p>
                            </div>
                        </div>

                        <div class="flex items-start gap-3">
                            <div class="w-8 h-8 rounded-xl bg-rose-50 text-rose-600 flex items-center justify-center text-sm font-bold shrink-0 mt-0.5">
                                <i class="ri-first-aid-kit-fill"></i>
                            </div>
                            <div class="space-y-0.5 text-xs">
                                <h4 class="font-bold text-slate-800">Emergency Bay Drop-off</h4>
                                <p class="text-slate-500 leading-relaxed">Direct ambulance and acute trauma driveway located on the East Wing, Gate 1.</p>
                            </div>
                        </div>

                        <div class="flex items-start gap-3">
                            <div class="w-8 h-8 rounded-xl bg-emerald-50 text-emerald-600 flex items-center justify-center text-sm font-bold shrink-0 mt-0.5">
                                <i class="ri-wheelchair-fill"></i>
                            </div>
                            <div class="space-y-0.5 text-xs">
                                <h4 class="font-bold text-slate-800">Wheelchair & Patient Concierge</h4>
                                <p class="text-slate-500 leading-relaxed">Attendants stationed at the main entrance for immediate wheelchair and stretcher transfer.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-slate-950 via-[#0a2f3c] to-slate-950 border border-[#114b5f]/40 rounded-3xl p-6 shadow-xl text-white text-center relative overflow-hidden space-y-4">
                    ...
                    <div class="relative z-10 space-y-4 flex flex-col items-center">
                        ...
                        <div class="space-y-1.5">
                            <h4 class="font-heading font-extrabold text-sm tracking-wide text-white">Trauma Emergency?</h4>
                            <p class="text-xs text-slate-300 leading-relaxed max-w-[220px] mx-auto">Call our 24/7 hotline for immediate ambulance dispatch.</p>
                        </div>
                        <a href="tel:18006784677" class="inline-flex items-center justify-center w-full py-2.5 sm:py-3 bg-gradient-to-r from-rose-600 to-rose-700 hover:from-rose-500 hover:to-rose-600 text-white font-bold text-xs rounded-xl shadow-md shadow-rose-600/20 active:scale-[0.99] transition-all cursor-pointer">
                            Call Helpline Now
                        </a>
                    </div>
                </div>
