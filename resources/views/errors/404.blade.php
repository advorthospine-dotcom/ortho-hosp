...
<head>
    ...
    <title>404 Page Not Found | Advanced Orthopaedic & Spine Center</title>
    ...
    <main class="flex-1 flex items-center justify-center p-4 sm:p-6 my-8">
        <div class="max-w-lg w-full bg-white rounded-3xl border border-slate-200/80 shadow-xl p-8 sm:p-10 text-center space-y-6">
            ...
            <div class="relative inline-block">
                <div class="w-24 h-24 sm:w-28 sm:h-28 rounded-3xl bg-teal-50 border-2 border-teal-200/80 flex items-center justify-center mx-auto shadow-md">
                    <span class="text-4xl sm:text-5xl font-heading font-extrabold text-[#114b5f]">404</span>
                </div>
            ...
            <!-- Header & Text -->
            <div class="space-y-2">
                <span class="text-xs font-bold uppercase tracking-widest text-[#114b5f] bg-teal-50 px-3 py-1 rounded-full border border-teal-200/80 inline-block">
                    Page Not Found
                </span>
                ...
                <p class="text-slate-600 text-xs sm:text-sm leading-relaxed">
                    The medical page or link you requested does not exist or has been moved.
                </p>
            </div>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
                ...
                <a href="/contact" class="w-full sm:w-auto px-5 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-xs rounded-xl border border-slate-200 transition-all inline-flex items-center justify-center gap-2">
                    <i class="ri-mail-send-fill text-sm text-[#114b5f]"></i>
                    <span>Contact OPD Desk</span>
                </a>
            </div>
